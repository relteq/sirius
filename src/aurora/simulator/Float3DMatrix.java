...
public class Float3DMatrix {
	...
	protected int n1;		// number of rows
	protected int n2;		// number of columns
	protected int n3;		// number of slices
	protected boolean isvector;			// 1-D matrices are converted to column vectors
	protected boolean isempty;			// true if there is no data;
	protected Integer length = null;	// defined if isvector
